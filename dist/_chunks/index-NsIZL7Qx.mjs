...
const SEOAccordion = ({ title, status, component, label }) => {
  ...
  return /* @__PURE__ */ jsx(Accordion.Root, { children: /* @__PURE__ */ jsxs(Accordion.Item, { value: "acc-01", children: [
    /* @__PURE__ */ jsxs(Accordion.Header, { children: [
      ...
      /* @__PURE__ */ jsx(Accordion.Actions, { children: /* @__PURE__ */ jsx(IconButton, { label, withTooltip: false, children: /* @__PURE__ */ jsx(Information, {}) }) })
    ] }),
...
const OpenGraphPreview = ({ modifiedData }) => {
  ...
  return /* @__PURE__ */ jsxs(Modal.Content, { labelledBy: "title", children: [
    ...
    /* @__PURE__ */ jsx(Modal.Body, { children: openGraph["og:title"] && openGraph["og:description"] && openGraph["og:image"] ? /* @__PURE__ */ jsxs(Fragment, { children: [
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./index-xXXgvB3Z.mjs");
        return App;
      }
    });
    app.registerPlugin({
...
//# sourceMappingURL=index-NsIZL7Qx.mjs.map
